    ...
    def __init__(self, force_generate=False):
        ...
        self.trends_by_theme = {
            ...
            "PR и коммуникации": [
                ...
                "Борьба с дезинформацией и deepfakes",
...
2. ОТДЕЛЬНАЯ ПУСТАЯ СТРОКА
3. Основная часть: Анализ явления, кейсы, данные, исследования.
4. ОТДЕЛЬНАЯ ПУСТАЯ СТРОКА
5. Практический блок: Что делать с этой информацией, конкретные шаги.
6. ОТДЕЛЬНАЯ ПУСТАЯ СТРОКА
7. Мини-вывод или ключевая мысль (инсайт).
8. ОТДЕЛЬНАЯ ПУСТАЯ СТРОКА
9. Мягкий финал: {soft_final}
10. ОТДЕЛЬНАЯ ПУСТАЯ СТРОКА
11. Хештеги: {hashtags_str}
...
Создай два РАЗНЫХ текста по одной теме. Оба должны быть уникальными по структуре, но об одном смысле."""
    ...
    def format_zen_text(self, text, slot_style):
        ...
        # ГАРАНТИЯ: Убедимся, что у Дзен поста есть структура «Крючок-убийца»
        lines = text.split('\n')
