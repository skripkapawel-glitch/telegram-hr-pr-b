...
class TelegramBot:
    ...
    def _clean_metadata(self, text: str, post_type: str) -> str:
        ...
        for line in text.split('\n'):
            ...
            # Удаляем метки типа "ЗАГОЛОВОК:", "АБЗАЦ 1:", "АБЗАЦ 2:", "ЯКОРЬ:" и т.д.
            markers_to_remove = [
...
[2] АБЗАЦ 1: Разверни тему. 1-3 предложения. Начни с разных подходов: статистика, пример, вопрос к читателю.
