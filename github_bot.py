...
[2] АБЗАЦ 1: Свободный вход в мысль и небольшое развитие. 2-3 предложений.
...
[2] АБЗАЦ 1: Разверни тему и небольшое развитие мысли. 2-3 предложений.

[3] ЯКОРЬ: Фиксируй значение или вывод. Начни ТОЛЬКО со слов "В итоге:". 1 предложения.
...
"""
    ...
    def check_post_complete(self, text: str, post_type: str, slot_style: Dict = None) -> bool:
        ...
        if post_type == 'telegram':
            ...
            # Zen: "В итоге:", вопрос, хештеги, без эмодзи
            has_anchor = 'В итоге:' in text
            has_question = '?' in text
            has_hashtags = '#' in text
            ...
            return has_anchor and has_question and has_hashtags and has_no_emoji
