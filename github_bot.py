...
ЛИМИТ СИМВОЛОВ: {tg_min}-{tg_max} символов ВКЛЮЧАЯ ХЕШТЕГИ
...
6. Объём ВСЕГО поста (включая хештеги): {tg_min}-{tg_max} символов (максимум {tg_tokens} токенов) (ОБЯЗАТЕЛЬНО!)

ВАЖНО: Хештеги должны быть сгенерированы тобой и ВКЛЮЧЕНЫ в общий подсчет символов!
...
ЛИМИТ СИМВОЛОВ: {zen_min}-{zen_max} символов ВКЛЮЧАЯ ХЕШТЕГИ
...
6. Объём ВСЕГО поста (включая хештеги): {zen_min}-{zen_max} символов (максимум {zen_tokens} токенов) (ОБЯЗАТЕЛЬНО!)
