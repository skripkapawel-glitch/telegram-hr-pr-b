...
DZEN: [текст Дзен-поста]"""
    ...
    def run_autopilot_mode(self):
        """Запуск в режиме автопилота (постоянная работа)"""
        print("\n" + "=" * 80)
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        print("2. python bot.py --now                 - Немедленная отправка (для workflow)")
        print("3. python bot.py --now --slot morning  - Отправка утреннего поста сейчас")
        print("4. python bot.py --test                - Ручное тестирование (пост сейчас)")
        print("5. python bot.py --test --slot morning - Тест утреннего поста")
        print("6. python bot.py --once                - Однократный запуск (для GitHub Actions)")
