...
[2] АБЗАЦ 1: Свободный вход в мысль и небольшое развитие.
...
[2] АБЗАЦ 1: Разверни тему и небольшое развитие мысли.

[3] ЯКОРЬ: Фиксируй значение или вывод. Начни ТОЛЬКО со слов "В итоге:".
