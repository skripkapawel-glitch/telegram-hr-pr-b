...
class TelegramBot:
    ...
    def create_prompt(self, theme, slot_info, text_format):
        ...
        format_instructions = {
            ...
            "выявление причин «почему так происходит»": "Погрузись в глубинные причины явления в выбранной теме. Почему все устроено именно так? Какие скрытые механизмы?",
...
• ПРОБЕЛЫ, ПЕРЕНОСЫ СТРОК, ВСЕ — ЭТО СИМВОЛЫ

ЖЕСТКАЯ СТРУКТУРА TELEGRAM (БЕЗ ОТКЛОНЕНИЙ):
...
══════════════════════════════════════════════════════════════════════════════════
ЖЕСТКАЯ СТРУКТУРА ДЗЕН (БЕЗ ОТКЛОНЕНИЙ):
...
НИКАКИХ КОММЕНТАРИЕВ, НИКАКИХ ОПИСАНИЙ, ТОЛЬКО ДВА ТЕКСТА!"""
    ...
    def get_post_image(self, theme):
        ...
        # Дефолтная картинка если все сломалось
