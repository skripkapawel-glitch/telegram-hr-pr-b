...
═══════════════════════════════════════════════════
❗️❗️❗️ ВАЖНО: СТРОГО СОБЛЮДАЙ ОБЪЁМЫ! ❗️❗️❗️
═══════════════════════════════════════════════════
...
НИКАКИХ ДОПОЛНИТЕЛЬНЫХ ПОЯСНЕНИЙ, ТОЛЬКО ДВА ТЕКСТА В УКАЗАННОМ ФОРМАТЕ!"""
    ...
    def format_telegram_text(self, text, slot_info):
        """Форматирует текст для Telegram с проверкой объема"""
        if not text:
            return ""
