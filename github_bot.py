...
Смысловой якорь. Фиксация значения или последствий без морали и клише.
...
2. Обязательно задай вопрос в конце
    ...
    def generate_with_retry(self, theme: str, slot_style: Dict, text_format: str, image_description: str,
        ...
        for attempt in range(max_attempts):
            ...
            if generated_zen:
                ...
                anchor_markers = ['Смысловой якорь', 'Значит', 'Поэтому', 'Таким образом', 'Следовательно', 
    ...
    def generate_with_retry(self, theme: str, slot_style: Dict, text_format: str, image_description: str,
        ...
        for attempt in range(max_attempts):
            ...
            if generated_zen:
                ...
                # Гибкая проверка для Zen
                # 1. Без эмодзи
                # 2. Есть ли вопрос в конце
                # 3. Есть ли вывод/заключение
                # 4. Подходящая ли длина
                ...
                if has_question and has_conclusion and zen_min <= zen_length <= zen_max:
                    ...
                    logger.warning(f"⚠️ Zen не прошел гибкую проверку: вопрос={has_question}, вывод={has_conclusion}")
