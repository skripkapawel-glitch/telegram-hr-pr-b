...
[4] КЛЮЧЕВАЯ МЫСЛЬ: одна явная и конкретная мысль по теме. 1-2 предложения. Сформулируй уникально.
...
3. Вопрос в блоке [5] заканчивается знаком ? и отличается от вопроса в заголовке
