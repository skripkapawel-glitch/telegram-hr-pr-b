...
[4] ВОПРОС: Задай ПОЛНЫЙ, ЗАКОНЧЕННЫЙ вопрос читателю. Отдельная строка. Заканчивается знаком ?. Вопрос должен отличаться от заголовка и быть полностью сформулированным.
...
10. УБЕДИСЬ, ЧТО ВСЕ 5 БЛОКОВ УМЕЩАЮТСЯ В {tg_token_min}-{tg_token_max} ТОКЕНОВ
11. ЕСЛИ НЕ ХВАТАЕТ ТОКЕНОВ - СОКРАТИ ПРЕДЫДУЩИЕ БЛОКИ, НО НЕ ОБРЕЗАЙ ПОСЛЕДНИЙ
