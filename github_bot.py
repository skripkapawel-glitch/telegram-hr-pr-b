...
ТЕЛЕГРАМ — ФИНАЛЬНАЯ СТРУКТУРА

Правило №0: Между всеми блоками обязательная пустая строка.
Блоки можно пропускать только третий абзац и структурирующие элементы (шаги, практика), всё остальное — обязательно.

1. Заголовок
   {slot_style['emoji']} [Отдельная строка, с эмодзи]
   Формулирует тему или позицию, не объясняет и не обещает пользы.

   [пустая строка]

2. Первый абзац
   Начало мысли.
   Один завершённый абзац.
   Может быть утверждением, наблюдением, тезисом или сомнением.

   [пустая строка]

3. Второй абзац
   Развитие мысли, углубление или усложнение.
   Обязательный завершённый абзац, который логически продолжает первый.

   [пустая строка]

4. Третий абзац (опционально)
   Усиление, уточнение или смысловой поворот.
   Завершённый абзац.

   [пустая строка]

5. 🎯 Важно
   Формат: 🎯 Важно: конкретная мысль.
   Обязательная завершённая мысль, фиксирующая суть поста.

   [пустая строка]

6. Вопрос для аудитории
   Формат: ВОПРОС ДЛЯ АУДИТОРИИ: конкретный вопрос?
   Открывающий вопрос, не итоговый.

   [пустая строка]

7. Хештеги
   2–5 тематических.
   Последняя строка поста: {hashtags}

💡 КЛЮЧЕВЫЕ ПРАВИЛА:
- Каждый блок отдельный абзац с пустой строкой
...
ЯНДЕКС ДЗЕН — ФИНАЛЬНАЯ СТРУКТУРА

Правило №0: Между всеми блоками обязательная пустая строка.
Блоки можно пропускать только третий абзац, всё остальное — обязательно.

1. Шапка (провокационный вопрос или утверждение)
   Одна строка, задаёт угол зрения, напряжение или позицию.

   [пустая строка]

2. Первый абзац
   Разворачивает тему или направление мысли.
   Не даёт выводов, не даёт советов.

   [пустая строка]

3. Второй абзац
   Продолжение темы, логическое развитие, сравнение, противопоставление, смена масштаба.
   Завершённый абзац.

   [пустая строка]

4. Третий абзац (опционально)
   Смысловой поворот, парадокс, неожиданное следствие.
   Не вывод, не мораль.

   [пустая строка]

5. Смысловой якорь
   Обязательный блок: один из вариантов:
   Почему это важно: …
   Что из этого следует: …
   Мнение экспертов: …
   Завершённая мысль, фиксирующая ценность.

   [пустая строка]

6. Вопрос для обсуждения
   Формат: ВОПРОС ДЛЯ ОБСУЖДЕНИЯ: конкретный вопрос?
   Открывающий вопрос, расширяет тему, не закрывает её.

   [пустая строка]

7. Хештеги
   2–5 тематических.
   Последняя строка: {hashtags}
