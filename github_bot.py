...
ЛИМИТ СИМВОЛОВ: {tg_min}-{tg_max} символов
...
Создай ТОЛЬКО Telegram пост по теме '{theme}'."""
...
ЛИМИТ СИМВОЛОВ: {zen_min}-{zen_max} символов
...
Создай ТОЛЬКО Дзен пост по теме '{theme}'."""
